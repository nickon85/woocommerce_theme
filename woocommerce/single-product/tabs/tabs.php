...
if ( ! empty( $product_tabs ) ) : ?>
    ...
    <div class="woocommerce-tabs wc-tabs-wrapper">
        <ul class=" wc-tabs nav nav-tabs" role="tablist"> <!-- Removed .tabs -->
        ...
        <div class="tab-content" id="myTabContent">
			<?php $i = 0; foreach ( $product_tabs as $key => $product_tab ) : ?>
                <div class="tab-pane fade <?php if ( ! $i ) echo 'show active' ?> woocommerce-Tabs-panel woocommerce-Tabs-panel--<?php echo esc_attr( $key ); ?> panel entry-content"
